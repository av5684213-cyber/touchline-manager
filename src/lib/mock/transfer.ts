...
export function generateFreeAgentListings(count = 15): FreeAgentListing[] {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const player: Player = {
      ...
      // v2.9.22 Y5: Eksik stat'lar eklendi — takımsız oyuncuların profil modal'ında görünmüyor
      // PlayerStats tipinde yok, bu yüzden doğrudan rand() ile üret
      finishing: rand(ovr - 10, ovr + 10),
      firstTouch: rand(ovr - 5, ovr + 5),
      crossing: rand(ovr - 10, ovr + 10),
      technique: rand(ovr - 5, ovr + 5),
      tackling: rand(ovr - 10, ovr + 10),
      marking: rand(ovr - 10, ovr + 10),
      longShots: rand(ovr - 15, ovr + 5),
      heading: rand(ovr - 10, ovr + 10),
      vision: rand(ovr - 5, ovr + 5),
      control: rand(ovr - 5, ovr + 5),
      stamina: rand(ovr - 5, ovr + 5),
      // Mental stats
      aggression: rand(40, 80),
      bravery: rand(40, 80),
      workRate: rand(40, 80),
      decisions: rand(40, 80),
      determination: rand(40, 80),
      concentration: rand(40, 80),
      leadership: rand(20, 60),
      anticipation: rand(40, 80),
      flair: rand(20, 70),
      positioning: rand(40, 80),
      composure: rand(40, 80),
      teamwork: rand(40, 80),
      // Physical stats
      agility: rand(40, 80),
      balance: rand(40, 80),
      strength: rand(40, 80),
      acceleration: rand(40, 80),
      jumping: rand(40, 80),
      leftFoot: rand(20, 60),
      rightFoot: rand(60, 95),
      // GK stats (sadece kaleci için)
      goalkeeping: pos === "GK" ? rand(ovr - 5, ovr + 5) : 0,
      stats,
      cond: rand(70, 100),
