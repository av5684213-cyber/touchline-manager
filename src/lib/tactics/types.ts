...
export const FORMATION_PITCH: Record<string, PitchCoord[]> = {
  "4-4-2": [
    { x: 50, y: 8 }, { x: 12, y: 25 }, { x: 36, y: 22 }, { x: 64, y: 22 }, { x: 88, y: 25 },
    { x: 14, y: 50 }, { x: 38, y: 48 }, { x: 62, y: 48 }, { x: 86, y: 50 },
    { x: 38, y: 80 }, { x: 62, y: 80 },
  ],
  "4-3-3": [
    { x: 50, y: 8 }, { x: 12, y: 25 }, { x: 36, y: 22 }, { x: 64, y: 22 }, { x: 88, y: 25 },
    { x: 28, y: 52 }, { x: 50, y: 48 }, { x: 72, y: 52 },
    { x: 86, y: 78 }, { x: 50, y: 84 }, { x: 14, y: 78 },
  ],
  "4-2-3-1": [
    { x: 50, y: 8 }, { x: 12, y: 25 }, { x: 36, y: 22 }, { x: 64, y: 22 }, { x: 88, y: 25 },
    { x: 38, y: 42 }, { x: 62, y: 42 },
    { x: 50, y: 62 }, { x: 82, y: 62 }, { x: 18, y: 62 }, { x: 50, y: 82 },
  ],
  "4-1-4-1": [
    { x: 50, y: 8 }, { x: 12, y: 25 }, { x: 36, y: 22 }, { x: 64, y: 22 }, { x: 88, y: 25 },
    { x: 50, y: 38 }, { x: 16, y: 58 }, { x: 38, y: 56 }, { x: 62, y: 56 }, { x: 84, y: 58 },
    { x: 50, y: 82 },
  ],
  "4-5-1": [
    { x: 50, y: 8 }, { x: 12, y: 25 }, { x: 36, y: 22 }, { x: 64, y: 22 }, { x: 88, y: 25 },
    { x: 14, y: 52 }, { x: 34, y: 50 }, { x: 50, y: 40 }, { x: 66, y: 50 }, { x: 86, y: 52 },
    { x: 50, y: 82 },
  ],
  "4-3-2-1": [
    { x: 50, y: 8 }, { x: 12, y: 25 }, { x: 36, y: 22 }, { x: 64, y: 22 }, { x: 88, y: 25 },
    { x: 28, y: 54 }, { x: 50, y: 50 }, { x: 72, y: 54 },
    { x: 38, y: 72 }, { x: 62, y: 72 }, { x: 50, y: 88 },
  ],
  "4-4-1-1": [
    { x: 50, y: 8 }, { x: 12, y: 25 }, { x: 36, y: 22 }, { x: 64, y: 22 }, { x: 88, y: 25 },
    { x: 14, y: 50 }, { x: 38, y: 48 }, { x: 62, y: 48 }, { x: 86, y: 50 },
  ...
  "4-3-1-2": [
    { x: 50, y: 8 }, { x: 12, y: 25 }, { x: 36, y: 22 }, { x: 64, y: 22 }, { x: 88, y: 25 },
    { x: 28, y: 52 }, { x: 50, y: 48 }, { x: 72, y: 52 },
    { x: 50, y: 68 }, { x: 38, y: 84 }, { x: 62, y: 84 },
  ],
  "3-5-2": [
    { x: 50, y: 8 }, { x: 28, y: 22 }, { x: 50, y: 20 }, { x: 72, y: 22 },
    { x: 10, y: 50 }, { x: 32, y: 48 }, { x: 50, y: 40 }, { x: 68, y: 48 }, { x: 90, y: 50 },
    { x: 38, y: 80 }, { x: 62, y: 80 },
  ],
  "3-4-3": [
    { x: 50, y: 8 }, { x: 28, y: 22 }, { x: 50, y: 20 }, { x: 72, y: 22 },
    { x: 12, y: 50 }, { x: 38, y: 48 }, { x: 62, y: 48 }, { x: 88, y: 50 },
    { x: 84, y: 78 }, { x: 50, y: 84 }, { x: 16, y: 78 },
  ],
  "3-1-4-2": [
    { x: 50, y: 8 }, { x: 28, y: 22 }, { x: 50, y: 20 }, { x: 72, y: 22 },
    { x: 50, y: 38 },
    { x: 16, y: 58 }, { x: 38, y: 56 }, { x: 62, y: 56 }, { x: 84, y: 58 },
    { x: 38, y: 80 }, { x: 62, y: 80 },
  ],
  "3-3-3-1": [
    { x: 50, y: 8 }, { x: 28, y: 22 }, { x: 50, y: 20 }, { x: 72, y: 22 },
    { x: 30, y: 50 }, { x: 50, y: 46 }, { x: 70, y: 50 },
    { x: 84, y: 72 }, { x: 50, y: 70 }, { x: 16, y: 72 },
    { x: 50, y: 86 },
  ],
  "5-4-1": [
    { x: 50, y: 8 }, { x: 8, y: 35 }, { x: 28, y: 22 }, { x: 50, y: 20 }, { x: 72, y: 22 }, { x: 92, y: 35 },
    { x: 16, y: 54 }, { x: 38, y: 52 }, { x: 62, y: 52 }, { x: 84, y: 54 },
    { x: 50, y: 82 },
  ],
  "5-3-2": [
    { x: 50, y: 8 }, { x: 8, y: 35 }, { x: 28, y: 22 }, { x: 50, y: 20 }, { x: 72, y: 22 }, { x: 92, y: 35 },
