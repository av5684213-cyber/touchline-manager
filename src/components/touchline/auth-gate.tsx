...
// v2.9.156: Google Sign-In ikonu için
        ...
        {mode === "landing" && (
          <>
            ...
            <div className="w-full max-w-[280px] space-y-2.5">
              ...
              {supabaseReady ? (
                <>
                  {/* v2.9.156: Google ile Giriş — en üstte, büyük beyaz buton */}
                  <button
                    onClick={async () => {
                      haptic("light");
                      setError("");
                      ...
                      // Başarılıysa Supabase redirect yapacak — setSubmitting false gerekmez
                    }}
                    disabled={submitting}
                    className="tm-tap w-full py-3 rounded-xl text-sm font-bold bg-white text-gray-800 border border-gray-300 shadow-md active:scale-[0.98] transition-transform flex items-center justify-center gap-2 disabled:opacity-50"
                  >
                  ...
                  <div className="flex items-center gap-2 my-2">
                    ...
                    <span className="text-[10px] text-muted-foreground">veya email ile</span>
                    <div className="flex-1 h-px bg-border" />
                  </div>
                  <button
