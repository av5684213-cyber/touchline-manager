...
const FORMATION_COORDS: Record<string, { x: number; y: number }[]> = {
  "4-4-2": [
    { x: 50, y: 8 },   // GK
    { x: 15, y: 28 }, { x: 38, y: 25 }, { x: 62, y: 25 }, { x: 85, y: 28 }, // DEF
    { x: 18, y: 50 }, { x: 40, y: 48 }, { x: 60, y: 48 }, { x: 82, y: 50 }, // MID
    { x: 38, y: 72 }, { x: 62, y: 72 }, // FWD
  ],
  "4-3-3": [
    { x: 50, y: 8 },
  ...
  "3-5-2": [
    { x: 50, y: 8 },
    { x: 28, y: 25 }, { x: 50, y: 22 }, { x: 72, y: 25 },
    { x: 12, y: 48 }, { x: 32, y: 45 }, { x: 50, y: 50 }, { x: 68, y: 45 }, { x: 88, y: 48 },
    { x: 38, y: 72 }, { x: 62, y: 72 },
  ],
  "5-3-2": [
    { x: 50, y: 8 },
    { x: 10, y: 30 }, { x: 28, y: 25 }, { x: 50, y: 22 }, { x: 72, y: 25 }, { x: 90, y: 30 },
