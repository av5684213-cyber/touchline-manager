-- =============================================================================
-- DEPRECATION NOTICE (v2.9.20 GÖREV 2)
-- =============================================================================
-- Bu migration DEPRECATED'tir. Yerine 014_cron_all_sims.sql kullanın.
-- 014 migration'ı 3 cron job tanımlar: match + cup + training.
-- Bu migration çalıştırılırsa 014 ile çakışmaz (014 önce unschedule yapar).
-- =============================================================================
